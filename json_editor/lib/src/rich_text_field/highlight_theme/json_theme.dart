...
class JsonTheme implements HighlightTheme {
  JsonTheme({
    ...
    TextStyle? errorStyle,
      ...
      TextStyle(color: Colors.blueGrey.shade900, fontSize: 16),
        ...
        keyStyle = keyStyle ??
            TextStyle(color: Colors.blueGrey.shade600, fontSize: 16),
  ...
  factory JsonTheme.dark() => JsonTheme(
      defaultStyle: TextStyle(color: Colors.white, fontSize: 16),
      bracketStyle: TextStyle(color: Colors.white70, fontSize: 16),
      numberStyle: TextStyle(color: Colors.blue.shade500, fontSize: 16),
      stringStyle: TextStyle(color: Colors.green.shade800, fontSize: 16),
      boolStyle: TextStyle(color: Colors.orange.shade800, fontSize: 16),
